...
function Commentators() {
    ...
    return /*#__PURE__*/ (0, _reactDefault.default).createElement(StyledCommentators, {
        ...
        $show: showSponsor,
        src: "/bundles/citadel-layouts/images/I_Play_Games.png",
...
const NameplateBox = (0, _styledComponentsDefault.default).div.withConfig({
    ...
    componentId: "sc-1d7sdi7-0"
})([
    "position:relative;display:flex;flex-direction:column;padding:10px;height:160px;width:600px;align-items:center;justify-content:space-evenly;text-align:center;background-image:url('/bundles/citadel-layouts/images/Chi_Banner.png');background-size:contain;background-repeat:no-repeat;color:var(--commentary-text);",
    ";",
    ""
